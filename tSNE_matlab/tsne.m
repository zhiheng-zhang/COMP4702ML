function [ydata,iteration_matrix] = tsne(X, labels, no_dims, initial_dims, perplexity)
...
% University of California, San Diego
    ...
    % Run t-SNE
    if initial_solution
        [ydata,iteration_matrix] = tsne_p(P, labels, ydata);
    else
        [ydata,iteration_matrix] = tsne_p(P, labels, no_dims);
    end

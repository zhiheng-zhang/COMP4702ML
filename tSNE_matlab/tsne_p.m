function [ydata,iteration_matrix] = tsne_p(P, labels, no_dims)
...
%         end
        ...
        if ~rem(iter, 10)
            ...
            iteration_matrix(1, iteration_counter) = iter;
            iteration_matrix(2, iteration_counter) =  cost;
